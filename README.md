...
<p>H&M의 본래 웹사이트와는 다른 디자인과 반응형 디자인 및 장바구니 기능, 카테고리 기능은 추가로 구현했습니다.</p>
...
- React.js를 이용하여 SPA를 구현하고 redux를 이용해 상태전역관리 이용.
- 로그인 상태를 useState의 상태로 구현. (해당 프로젝트는 back-end 부분 제외)
